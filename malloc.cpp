...
namespace myMalloc{
    ...
    void free(void *firstbyte) {
        ...
        mcb = (mem_control_block *)((mem_control_block *)firstbyte - sizeof(struct mem_control_block));
        mcb->is_available = 1;
        return;
    }
    ...
    void *malloc(long numbytes) {
        ...
        * to know this, so we'll just add it in for them. */
        ...
        current_location = (void *)((int *)current_location + current_location_mcb->size);
        }
        ...
        * have to ask the operating system for more memory */
        if (!memory_location) {
            ...
            last_valid_address = (void *)((int *)last_valid_address + numbytes);
        ...
        * the mem_control_block */
        ...
        memory_location = (void *)((int *)memory_location + sizeof(struct mem_control_block));
        /* Return the pointer */
